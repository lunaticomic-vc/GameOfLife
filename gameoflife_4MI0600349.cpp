...
int countNeighbours(vector<vector<bool>> field, size_t height, size_t width, size_t coordinateX, size_t coordinateY)
{
    ...
    int beginLoopHeight = coordinateX, endLoopHeight = coordinateX;
    int beginLoopWidth = coordinateY, endLoopWidth = coordinateY;
    ...
    else if (coordinateX == 0) endLoopHeight++;
    else beginLoopHeight--;
    ...
    else if (coordinateY == 0) endLoopWidth++;
    else beginLoopWidth--;
